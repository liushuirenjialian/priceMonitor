  ...
  <div class="dashboard-container">
    <el-form :model="peopleform" :inline="true" label-width="88px" ref="peopleform">
      <el-row>
          <el-col :span="8">
          <div>
            <el-form-item label="发布监测点" class="fourLabel">
         ...
         <el-col :span="8">
          <div>
            <el-form-item label="发布地区" class="fourLabel">
        ...
        <el-col :span="8">
          <div>
            <el-form-item label="发布状态" class="fourLabel">
          ...
          <el-col :span="8">
          <div>
            <el-form-item label="标题名称" class="fourLabel">
              <el-input placeholder="请输入" v-model="peopleform.companyName" clearable>
              </el-input>
            </el-form-item>
          </div>
          ...
          <div>
            <el-button class="outButton" icon="el-icon-search" size="mini"  type="primary">查询</el-button>
              <el-button class="outButton" icon="el-icon-search" size="mini"  type="primary">清空</el-button>
               <el-button class="outButton" icon="el-icon-search" size="mini"  type="primary">数据导出</el-button>
    ...
    <el-row>
      <el-table tooltip-effect="dark" style="width: 100%;margin-top:10px;" align="center" border stripe highlight-current-rowv-loading="tableLoading" :data="tableData">
        ...
        <el-table-column align="center" :show-overflow-tooltip="true" label="报送单位" sortable prop="companyName">
        </el-table-column>
        <el-table-column align="center" :show-overflow-tooltip="true" label="企业类型" sortable prop="companyHierarchy">
        </el-table-column>
        <el-table-column align="center" :show-overflow-tooltip="true" prop="reporter" label="填报人" sortable>
        </el-table-column>
             ...
             <el-tooltip class="item" effect="light" content="查看" placement="top">
              <el-button class="button" size="mini" type="primary" @click.stop="see(scope.row)">
                <i class="el-icon-zoom-in"></i>
                       ...
                       <el-tooltip class="item" effect="light" content="发布" placement="top">
              <el-button class="button" size="mini" type="primary" @click.stop="see(scope.row)">
