  ...
  <div class="dashboard-container">
    ...
    <el-row>
      <el-table tooltip-effect="dark" style="width: 100%;margin-top:10px;" align="center" border stripe highlight-current-rowv-loading="tableLoading" :data="tableData">
        ...
        <el-table-column align="center" :show-overflow-tooltip="true" label="监测点等级" width="310px" prop="companyName">
        </el-table-column>
        <el-table-column align="center" :show-overflow-tooltip="true" label="开始上报时间" prop="companyHierarchy">
        </el-table-column>
        <el-table-column align="center" :show-overflow-tooltip="true" prop="reporter" label="结束上报时间">
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    addBtn() {
      this.$router.push({ path: '/monitorArea/reportTimeDetail' })
    }
  }
}
</script>
